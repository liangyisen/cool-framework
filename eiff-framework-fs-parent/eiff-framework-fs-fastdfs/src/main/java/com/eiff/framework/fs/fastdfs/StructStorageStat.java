...
public class StructStorageStat extends StructBase {
	 ...
	 *            start offset
	 */
	public void setFields(byte[] bs, int offset, String charset) {
		this.status = byteValue(bs, offset, fieldsArray[FIELD_INDEX_STATUS]);
		this.id = stringValue(bs, offset, charset, fieldsArray[FIELD_INDEX_ID]);
		this.ipAddr = stringValue(bs, offset, charset, fieldsArray[FIELD_INDEX_IP_ADDR]);
		this.srcIpAddr = stringValue(bs, offset, charset, fieldsArray[FIELD_INDEX_SRC_IP_ADDR]);
		this.domainName = stringValue(bs, offset, charset, fieldsArray[FIELD_INDEX_DOMAIN_NAME]);
		this.version = stringValue(bs, offset, charset, fieldsArray[FIELD_INDEX_VERSION]);
