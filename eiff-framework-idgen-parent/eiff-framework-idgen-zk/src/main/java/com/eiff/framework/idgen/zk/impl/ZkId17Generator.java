 ...
 * @author tangzhaowei
 */
public class ZkId17Generator extends AbstractZkIdGenerator {

	public ZkId17Generator(String prefix, int preFetchCount, String dateFormat, String idNodeName, String zkAddress) {
