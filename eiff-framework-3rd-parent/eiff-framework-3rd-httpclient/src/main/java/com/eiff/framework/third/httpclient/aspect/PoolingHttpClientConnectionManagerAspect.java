...
@Aspect
public class PoolingHttpClientConnectionManagerAspect {
	...
	public Object invokeExecute(ProceedingJoinPoint pjp) throws Throwable {
		...
		Span span = buildTracer.createSpan("PoolingHttpClientConnectionManager", methodName);
		try {
	...
	@Pointcut("execution(public * org.apache.http.impl.conn.PoolingHttpClientConnectionManager.connect(org.apache.http.HttpClientConnection,org.apache.http.conn.routing.HttpRoute,int,org.apache.http.protocol.HttpContext))")
